...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		_rightConfig.motionAcceleration = 21200/2; //(distance units per 100 ms) per second
		_rightConfig.motionCruiseVelocity = 21200/2; //distance units per 100 ms
	...
	public void teleopPeriodic() {
		/* Gamepad processing */
		double forward = _gamepad.getRawAxis(1);
		...
		if(!_state){
			...
			double target_turn = _targetAngle * 10;
			...
			/*_leftMaster.set(ControlMode.MotionMagic, target_sensorUnits, DemandType.AuxPID, -target_turn);
			_rightFollower.follow(_rightMaster, FollowerType.AuxOutput1);
			_leftFollower.follow(_leftMaster, FollowerType.AuxOutput1);*/
		}
		_firstCall = false;
	}
